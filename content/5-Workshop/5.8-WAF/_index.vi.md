...
![Rules](- Quản lý secrets bằng AWS Secrets Manager và AWS KMS.
  - Triển khai hạ tầng bằng AWS CloudFormation.
  - Xây dựng CI/CD pipeline với CodeBuild và CodePipeline
/images/5-Workshop/5.8-WAF/rule.png)
...
![Associated AWS resources](- Quản lý secrets bằng AWS Secrets Manager và AWS KMS.
  - Triển khai hạ tầng bằng AWS CloudFormation.
  - Xây dựng CI/CD pipeline với CodeBuild và CodePipeline
/images/5-Workshop/5.8-WAF/associated.png)
...
![Curl command results](- Quản lý secrets bằng AWS Secrets Manager và AWS KMS.
  - Triển khai hạ tầng bằng AWS CloudFormation.
  - Xây dựng CI/CD pipeline với CodeBuild và CodePipeline
/images/5-Workshop/5.8-WAF/curl.png)
...
![Sampled requests](- Quản lý secrets bằng AWS Secrets Manager và AWS KMS.
  - Triển khai hạ tầng bằng AWS CloudFormation.
  - Xây dựng CI/CD pipeline với CodeBuild và CodePipeline
/images/5-Workshop/5.8-WAF/log.png)
