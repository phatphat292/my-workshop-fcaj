...
![Log](/my-workshop-fcaj/images/5-Workshop/5.7-CloudWatch-SNS/live.png)
...
![Topic](/my-workshop-fcaj/images/5-Workshop/5.7-CloudWatch-SNS/confirm.png)
...
![Alarm](/my-workshop-fcaj/images/5-Workshop/5.7-CloudWatch-SNS/alarm.png)
...
![Trigger alarm](/my-workshop-fcaj/images/5-Workshop/5.7-CloudWatch-SNS/inalarm.png)

**Clean up after testing:** 
Back on the DLQ page, **Actions → Purge** emptied the queue. After the next ~5-minute cycle, the alarm returned to green **OK**.

![Recovery](/my-workshop-fcaj/images/5-Workshop/5.7-CloudWatch-SNS/outalarm.png)
